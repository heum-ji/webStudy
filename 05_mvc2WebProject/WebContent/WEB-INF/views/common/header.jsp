      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="/view/mail.jsp">메일 API</a>
                <a class="dropdown-item" href="/view/map.jsp">지도 API</a>
          ...
          <% if (m==null) { %>
            ...
            <% } else { %>
              <a class="btn btn-secondary my-2 my-sm-0" href="/mypage1">
                <%=m.getMemberName()%>
              </a>
            ...
            <div class="modal-content">
              ...
              <form action="/login" method="post" name="loginFrm">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-secondary cls" data-dismiss="modal"
                    onclick="initInputs();">닫기</button>
                </div>
                <div class="modal-footer">
                  <a href="#">아이디/비밀번호찾기</a>
                </div>
